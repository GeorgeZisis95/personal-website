  ...
  return (
    <section ref={aboutRef} id="about" className="about">
      ...
      <div className="about-container">
        <img src={hipsterImg} alt="hipsterImg" />
        <p style={{ color: "var(--text)" }}>
          ...
          work mainly with modern tools and frameworks like React. I’m
          constantly learning and improving my skills through real-world
          ...
          friends, playing card games, and discovering new cafés, restaurants,
          and places to relax. These activities keep me curious, connected, and
          inspired.
        </p>
      </div>
    </section>
